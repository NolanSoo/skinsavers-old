...
const MODEL_FILENAME_TO_LOAD = "SKin_Cancer_Model_2.onnx"; // Centralized model filename
...
async function callGroqAPI(messages) {
  const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
    ...
    body: JSON.stringify({ model: "mixtral-8x7b-32768", messages, temperature: 0.6, max_tokens: 4096, top_p: 0.95 }),
  });
  if (!response.ok) {
